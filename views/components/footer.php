...
<?php if (page_uses_bootstrap_javascript($currentPage)): ?>
<script defer src="<?= e(versioned_asset_url('vendor/bootstrap/bootstrap.bundle.min.js')) ?>"></script>
<?php endif; ?>
<?php if (page_uses_datatables($currentPage)): ?>
<script defer src="<?= e(versioned_asset_url('vendor/datatables/jquery.dataTables.min.js')) ?>"></script>
<script defer src="<?= e(versioned_asset_url('vendor/datatables/dataTables.bootstrap5.min.js')) ?>"></script>
<script defer src="<?= e(versioned_asset_url('vendor/datatables/dataTables.responsive.min.js')) ?>"></script>
<script defer src="<?= e(versioned_asset_url('vendor/datatables/responsive.bootstrap5.min.js')) ?>"></script>
<script defer src="<?= e(versioned_asset_url('vendor/datatables/dataTables.buttons.min.js')) ?>"></script>
<script defer src="<?= e(versioned_asset_url('vendor/datatables/buttons.bootstrap5.min.js')) ?>"></script>
<script defer src="<?= e(versioned_asset_url('vendor/jszip/jszip.min.js')) ?>"></script>
<script defer src="<?= e(versioned_asset_url('vendor/datatables/buttons.html5.min.js')) ?>"></script>
<script defer src="<?= e(versioned_asset_url('vendor/datatables/buttons.print.min.js')) ?>"></script>
<?php endif; ?>
<?php if (page_uses_charts($currentPage)): ?>
<script defer src="<?= e(versioned_asset_url('vendor/chartjs/chart.umd.js')) ?>"></script>
<?php endif; ?>
